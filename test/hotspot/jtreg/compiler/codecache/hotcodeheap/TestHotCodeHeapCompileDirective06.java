...
/**
 * @test TestHotCodeHeapCompileDirective06
 * @summary Test marking Java methods with compiler directive UseState if MethodData
 *          is not available and HotCodeHeap is available. In such case compiler directive
 *          UseState has no effect. The absence of MethodData causes methods recompilations
 *          if compiler directives are updated.
 ...
 *                   -Xlog:codecache=trace -XX:-TieredCompilation -XX:-ProfileInterpreter
 *                   -XX:-ProfileTraps -XX:HotCodeHeapSize=4M
 *                   compiler.codecache.hotcodeheap.TestHotCodeHeapCompileDirective06
 *
 * @run main/othervm -Xbootclasspath/a:. -XX:+UnlockDiagnosticVMOptions -XX:+WhiteBoxAPI
...
public class TestHotCodeHeapCompileDirective06 extends TestHotCodeHeapCompileDirective {
