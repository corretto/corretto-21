 ...
 *                   -XX:-TieredCompilation -Xlog:codecache=trace
 *                   serviceability.dcmd.compiler.DirectivesRefreshTest04
 *
 * @run main/othervm -Xbootclasspath/a:. -XX:+UnlockDiagnosticVMOptions -XX:+WhiteBoxAPI
 *                   -XX:+BackgroundCompilation -XX:-TieredCompilation -XX:CICompilerCount=1
...
public class DirectivesRefreshTest04 {
    ...
    public static class AddRefreshTest05 extends AddRefreshTest {
        ...
        String getInitialDirectives() {
            return """
                [
                    {
                        match: "serviceability.dcmd.compiler.DirectivesRefreshTest04$AddRefreshTest05::*",
                        c2: {
                            Exclude: false
                        }
                    }
        ...
        String getDirectives() {
            return """
                [
                    {
                        match: "serviceability.dcmd.compiler.DirectivesRefreshTest04$AddRefreshTest05::callable01",
                        c2: {
                            Exclude: true
                        },
                    },
                    {
                        match: "serviceability.dcmd.compiler.DirectivesRefreshTest04$AddRefreshTest05::callable02",
                        c2: {
                            Exclude: true
                        },
                    },
                    {
                        match: "serviceability.dcmd.compiler.DirectivesRefreshTest04$AddRefreshTest05::callable03",
                        c2: {
                            Exclude: true
                        },
                    }
        ...
        static int callable01() {
            return DirectivesRefreshTest04.callable();
        }
        ...
        AddRefreshTest05() throws Exception{
            super();
    ...
    public static class AddRefreshTest06 extends AddRefreshTest {
        ...
        String getDirectives() {
            return """
                [
                    {
                        match: "serviceability.dcmd.compiler.DirectivesRefreshTest04$AddRefreshTest06::callable01",
                        c2: {
                            Exclude: true
                        },
                    },
                    {
                        match: "serviceability.dcmd.compiler.DirectivesRefreshTest04$AddRefreshTest06::callable02",
                        c2: {
                            Exclude: true
                        },
                    },
                    {
                        match: "serviceability.dcmd.compiler.DirectivesRefreshTest04$AddRefreshTest06::callable03",
                        c2: {
                            Exclude: true
                        },
                    }
        ...
        AddRefreshTest06() throws Exception {
            super();
            method1 = this.getClass().getDeclaredMethod("callable01");
            method2 = this.getClass().getDeclaredMethod("callable02");
            method3 = this.getClass().getDeclaredMethod("callable03");
    ...
    public static class AddRefreshTest07 extends AddRefreshTest {
        ...
        String getInitialDirectives() {
            return """
                [
                    {
                        match: "serviceability.dcmd.compiler.DirectivesRefreshTest04$AddRefreshTest07::callable01",
                        c2: {
                            Exclude: false
                        }
                    }
        ...
        String getDirectives() {
            return """
                [
                    {
                        match: "serviceability.dcmd.compiler.DirectivesRefreshTest04$AddRefreshTest07::callable02",
                        c2: {
                            Exclude: true
                        },
                    },
                    {
                        match: "serviceability.dcmd.compiler.DirectivesRefreshTest04$AddRefreshTest07::callable03",
                        c2: {
                            Exclude: true
                        },
                    }
        ...
        AddRefreshTest07() throws Exception {
            super();
            method1 = this.getClass().getDeclaredMethod("callable01");
            method2 = this.getClass().getDeclaredMethod("callable02");
            method3 = this.getClass().getDeclaredMethod("callable03");
